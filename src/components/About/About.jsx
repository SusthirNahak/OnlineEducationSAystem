...
const About = () => {
  return (
    ...
    <div className="about-right ">
        <h3>ABOUT US</h3>
        <h2>Why our education system is right choice for you</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur dolor excepturi numquam aliquam delectus deleniti debitis uasi nisi similique delectus inventore perferendis possimus dignissimos. Voluptates?</p>
